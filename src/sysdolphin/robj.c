...
extern HSD_ObjAllocData robj_alloc_data;
extern HSD_ObjAllocData rvalue_alloc_data;
...
extern double lbl_805E5CB8;

void RObjUpdateFunc(void* obj, s32 type, FObjData val)
{
    HSD_RObj* robj;
